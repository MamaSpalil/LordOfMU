...
// ----------------------------------------------------------------------------------------------
#define MAX_AH_DB				260
#define AH_TITLE				"Anti-Cheat"
#define DAMP_LOG_TEXT			"Hack_1: %s"
#define TITLE_WINDOW_TEXT		"Hack_2: %s"
#define CLASS_WINDOW_TEXT		"Hack_3: %s"
#define INJECT_TEXT				"Inject: %s"
#define PROCESS_ID_TEXT			"ProcessID: %s"
#define MULTI_WIN_TEXT			"Multi Windows Blocked"
...
public:
	...
	static DWORD WINAPI SpeedTimer(LPVOID lpParam);
