...
void Console::InitCore()
{
	...
	// ----
	this->ConsoleOutput(1,"[ DebugStart ] Client Start");
	this->ConsoleOutput(1,"[ DebugStart ] Client Version : 1.02.11jpn");
	this->ConsoleOutput(1,"[ DebugStart ] Server Version : Season 3 ep 1");
